...
<?php endif; ?> 
            ...
            <div class="col-lg-12 mt-0">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('All Document Items')); ?></h4>
                            ...
                            <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="tab-pane fade <?php if($b == 0): ?> show active <?php endif; ?>"
                                    ...
                                    <div class="table-wrap table-responsive">
                                        <table class="table table-default" id="all_document_table">
                                            <thead>
                                                <th class="no-sort">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                             <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-popover','data' => ['url' => route('admin.document.destroy', $data->id)]]); ?>
<?php $component->withName('delete-popover'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.document.destroy', $data->id))]); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?> 
                                                            ...
                                                            <a class="btn btn-xs btn-primary btn-xs mb-3 mr-1"
                                                                href="<?php echo e(route('admin.document.edit', $data->id)); ?>">
                                                                <i class="ti-pencil"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
        ...
        $(document).ready(function() {
            $(document).on('click', '#bulk_delete_btn', function(e) {
                ...
                if (allIds != '' && bulkOption == 'delete') {
                    ...
                    $.ajax({
                        'type': "POST",
                        'url': "<?php echo e(route('admin.document.bulk.action')); ?>",
                        'data': {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\penchtiger.org\@core\resources\views/backend/pages/document/index.blade.php ENDPATH**/ ?>