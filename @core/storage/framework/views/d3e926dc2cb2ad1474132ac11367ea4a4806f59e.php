...
<?php endif; ?> 
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <!-- form start -->
                        <form action="<?php echo e(route('admin.link.store')); ?>" method="POST" enctype="multipart/form-data"
                            class="form-horizontal">
                            <?php echo csrf_field(); ?>
                            <!-- Horizontal Form -->
                            <div class="card card-info mb-5">
                                <div class="card-header bg-dark text-white">
                                    <h3 class="card-title mb-0">IMPORTANT DOCUMENT</h3>
                                </div>
                                <!-- /.card-header -->
                                        ...
                                        <select name="categories" id="category"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($subcategory->id); ?>"><?php echo e($subcategory->name); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u376743586/domains/penchtiger.org/public_html/@core/resources/views/backend/pages/important-links/create.blade.php ENDPATH**/ ?>