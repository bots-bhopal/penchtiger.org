            ...
            <div class="row no-gutters">
                <div class="col-lg-6">
                    <div class="contact-info">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section-title">
                                    <h4 class="title">
                                        <?php echo e(get_static_option('contact_page_' . $user_select_lang_slug . '_form_section_title')); ?>
                        ...
                        <form action="<?php echo e(route('frontend.contact.message')); ?>" method="post" class="contact-page-form"
                            ...
                            <div class="btn-wrapper">
                                <button type="submit"
                                    class="boxed-btn reverse-color"><?php echo e(get_static_option('contact_page_' . $user_select_lang_slug . '_form_submit_btn_text')); ?></button>
                            </div>
...
<?php /**PATH /home/u376743586/domains/penchtiger.org/public_html/@core/resources/views/frontend/partials/contact-page-content.blade.php ENDPATH**/ ?>