...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('All Category Page')); ?>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <a href="<?php echo e(route('admin.subcategory.edit', $category->id)); ?>"
                                                            ...
                                                            <form id="delete-form-<?php echo e($category->id); ?>"
                                                                action="<?php echo e(route('admin.subcategory.destroy', $category->id)); ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="overflow-y: unset;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="delCategory"><?php echo e(__('Yes')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\penchtiger.org\@core\resources\views/backend/pages/important-links/sub-category/index.blade.php ENDPATH**/ ?>