                    ...
                    <div class="col-md-6 col-sm-4 clearfix">
                        <ul class="notification-area pull-right">
                            ...
                            <li><a class="btn btn-primary" target="_blank"
                                    href="<?php echo e(url('/')); ?>"><?php echo e(__('View Site')); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="user-profile pull-right">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item"
                                    href="<?php echo e(route('admin.profile.update')); ?>"><?php echo e(__('Edit Profile')); ?></a>
                                <a class="dropdown-item"
                                    href="<?php echo e(route('admin.password.change')); ?>"><?php echo e(__('Password Change')); ?></a>
...
<?php /**PATH /home/u376743586/domains/penchtiger.org/public_html/@core/resources/views/backend/admin-master.blade.php ENDPATH**/ ?>