...
<?php if((request()->routeIs('homepage') || request()->routeIs('frontend.homepage.demo')) && $home_page_variant == '17' && filter_static_option_value('home_page_call_to_action_section_status', $static_field_data)): ?> has-top-padding <?php endif; ?>
">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center" style="font-weight:500;font-size:16px;color:#fff;letter-spacing:0.8px;">
                            ...
                            <?php echo e(trans('Total Number of Visitors :')); ?>

                
                            <?php echo e($trackers->sum('hits')); ?>
...
<!-- News Slider -->
<script src="<?php echo e(asset('assets/frontend/js/jquery.bootstrap.newsbox.min.js')); ?>"></script>
...
<?php /**PATH /home/u376743586/domains/penchtiger.org/public_html/@core/resources/views/frontend/partials/footer.blade.php ENDPATH**/ ?>