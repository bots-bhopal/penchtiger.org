    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- form start -->
                <form action="<?php echo e(route('admin.link.update', $links->id)); ?>" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="card-body pb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="title" class="form-control" id="title" name="title"
                                            value="<?php echo e($links->title); ?>" placeholder="<?php echo e(__('Enter Title')); ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="categories" id="category"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($links->category_id == $category->id): ?> selected <?php endif; ?> value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?>
                                    ...
                                    <div class="form-group website-url">
                                        ...
                                        <input type="url" class="form-control" id="customurl" name="customurl"
                                            value="<?php echo e($links->url); ?>" placeholder="<?php echo e(__('https://www.example.com')); ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u376743586/domains/penchtiger.org/public_html/@core/resources/views/backend/pages/important-links/edit.blade.php ENDPATH**/ ?>