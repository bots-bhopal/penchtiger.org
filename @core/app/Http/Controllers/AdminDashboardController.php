...
class AdminDashboardController extends Controller
{
    ...
    public function adminIndex()
    {
        ...
        $all_news = News::where('lang', $default_lang)->count();
        $all_tender = Tender::where('lang', $default_lang)->count();
        $all_document = Document::where('lang', $default_lang)->count();
        ...
        return view('backend.admin-home')->with([
            ...
            'news_count' => $all_news,
            'tender_count' => $all_tender,
            'document_count' => $all_document,
