...
class GeneralSettingsController extends Controller
{
    ...
    public function update_page_settings(Request $request)
    {
        $this->validate($request, [
            ...
            'news_page_slug' => 'required|string|max:191',
            'tender_page_slug' => 'required|string|max:191',
            'document_page_slug' => 'required|string|max:191',
            'link_page_slug' => 'required|string|max:191',
        ...
        $slug_list = [
            'about', 'service', 'blog', 'news', 'tender', 'document', 'link', 'contact', 'image_gallery'
        ];
        ...
        //     'faq', 'price_plan', 'blog', 'news', 'link', 'contact',
        ...
        foreach ($all_languages as $lang) {
            $this->validate($request, [
                ...
                'news_page_' . $lang->slug . '_name' => 'nullable|string',
                'tender_page_' . $lang->slug . '_name' => 'nullable|string',
                'document_page_' . $lang->slug . '_name' => 'nullable|string',
                'link_page_' . $lang->slug . '_name' => 'nullable|string',
