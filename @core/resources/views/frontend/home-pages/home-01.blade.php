...
@if (!empty(filter_static_option_value('home_page_case_study_section_status', $static_field_data)))
    <div class="case-studies-area">
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="case-studies-slider-active global-carousel-init" data-loop="true" data-desktopitem="3"
                        data-mobileitem="1" data-tabletitem="2" data-nav="true" data-center="true"
                        data-autoplay="true" data-margin="30">
                        @foreach ($all_work as $data)
                            <div class="slider-img" {!! render_background_image_markup_by_attachment_id($data->image) !!}>
                ...
                <div class="col-lg-12">
                    <div class="price-plan-slider global-carousel-init" data-loop="true" data-desktopitem="3"
                        ...
                        @foreach ($all_price_plan as $data)
                            <div
                                class="single-price-plan-01 @if (!empty($data->highlight)) style-03 active @endif">
