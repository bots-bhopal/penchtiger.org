<style>
    ...
    /* navbar style 02 */
    @if (get_static_option('navbar_variant') == '02').navbar-variant-02 .navbar-area,
    ...
    .navbar-variant-02 .navbar-area .nav-container .navbar-collapse .navbar-nav li.current-menu-item a {
        color: {{ get_static_option('navbar_dropdown_hover_text_color', 'var(--main-color-one)') }};
         !important;
    }
    ...
    /* navbar style 03 */
    @if (get_static_option('navbar_variant') == '03').navbar-variant-03 .header-style-03.header-variant-07 .nav-container,
    ...
    /* navbar style 04 */
    @if (get_static_option('navbar_variant') == '04').header-style-03.navbar-variant-04 .navbar-area,
    ...
    /* navbar style 05 */
    @if (get_static_option('navbar_variant') == '05').navbar-variant-05 .navbar-area,
    ...
    /* navbar style 06 */
    @if (get_static_option('navbar_variant') == '06').navbar-variant-06 .navbar-area .nav-container {
    ...
    .breadcrumb-area:before {
        background-color: {{ get_static_option('breadcrumb_background_overlay_color', 'rgba(0, 0, 0, .4)') }};
    }
