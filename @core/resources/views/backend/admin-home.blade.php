            ...
            <div class="col-lg-12">
                    ...
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                                ...
                                <div class="content">
                                    <span class="total">{{$news_count}}</span>
                ...
                @if(check_page_permission_by_string('Tenders Manage'))
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                                <a href="{{route('admin.tender.new')}}" class="add-new"><i class="ti-plus"></i></a>
                                <div class="icon">
                                    <i class="ti-comments"></i>
                                </div>
                                <div class="content">
                                    <span class="total">{{$tender_count}}</span>
                                    <h4 class="title">{{__('Total Tenders')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if(check_page_permission_by_string('Documents Manage'))
                    <div class="col-md-3 mt-md-5 mb-3">
                        <div class="card text-dark  mb-3">
                            <div class="dsh-box-style">
                                <a href="{{route('admin.document.new')}}" class="add-new"><i class="ti-plus"></i></a>
                                <div class="icon">
                                    <i class="ti-comments"></i>
                                </div>
                                <div class="content">
                                    <span class="total">{{$tender_count}}</span>
                                    <h4 class="title">{{__('Total Documents')}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
