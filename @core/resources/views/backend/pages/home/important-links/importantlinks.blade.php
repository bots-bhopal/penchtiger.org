            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                                ...
                                                @foreach ($all_docs as $key => $docs)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('admin.home07.important.links.edit', $docs->id) }}"
                                                            ...
                                                            <form id="delete-form-{{ $docs->id }}"
                                                                action="{{ route('admin.home07.important.links.destroy', $docs->id) }}"
                    ...
                    <div class="col-lg-5 col-md-5">
                        <!-- form start -->
                        <form action="{{ route('admin.home07.important.links.store') }}" method="POST"
