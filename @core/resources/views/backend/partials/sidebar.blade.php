            ...
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                        ...
                        ">
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ active_menu('admin-home/news/page-settings') }}"><a
                                        href="{{ route('admin.news.page.settings') }}">{{ __('News Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif

                    @if (check_page_permission_by_string('Tenders Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/tender/*', 'admin-home/tender'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Tenders') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/tender') }}"><a
                                        href="{{ route('admin.tender') }}">{{ __('All Tenders') }}</a></li>
                                <li class="{{ active_menu('admin-home/tender/new') }}"><a
                                        href="{{ route('admin.tender.new') }}">{{ __('Add New Tender') }}</a></li>
                                <li class="{{ active_menu('admin-home/tender/page-settings') }}"><a
                                        href="{{ route('admin.tender.page.settings') }}">{{ __('Tender Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif

                    @if (check_page_permission_by_string('Documents Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/document/*', 'admin-home/document'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Documents') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/document') }}"><a
                                        href="{{ route('admin.document') }}">{{ __('All Documents') }}</a></li>
                                <li class="{{ active_menu('admin-home/document/new') }}"><a
                                        href="{{ route('admin.document.new') }}">{{ __('Add New Document') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/document/page-settings') }}"><a
                                        href="{{ route('admin.document.page.settings') }}">{{ __('Document Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif

                    @if (check_page_permission_by_string('Link Manage'))
                        <li
                            class="main_dropdown
                        @if (request()->is(['admin-home/link/*', 'admin-home/link'])) active @endif
                        ">
                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i>
                                <span>{{ __('Important Notifications') }}</span></a>
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/link') }}">
                                    <a href="{{ route('admin.links') }}">{{ __('All Important Notifications') }}</a>
                                </li>
                                {{-- <li class="{{ active_menu('admin-home/link/category') }}">
                                    <a href="{{ route('admin.categories') }}">{{ __('All Parent Categories') }}</a>
                                </li> --}}
                                <li class="{{ active_menu('admin-home/link/subcategory') }}">
                                    <a href="{{ route('admin.subcategories') }}">{{ __('All Categories') }}</a>
                                </li>
                                {{-- <li class="{{ active_menu('admin-home/link/new-category') }}">
                                    <a href="{{ route('admin.category.new') }}">{{ __('Add New Parent Category') }}</a>
                                </li> --}}
                                <li class="{{ active_menu('admin-home/link/new-subcategory') }}">
                                    <a href="{{ route('admin.subcategory.new') }}">{{ __('Add New Category') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/link/new') }}">
                                    <a href="{{ route('admin.link.new') }}">{{ __('Add Important Notifications') }}</a>
                                </li>
                                <li class="{{ active_menu('admin-home/link/page-settings') }}">
                                    <a href="{{ route('admin.links.page.settings') }}">{{ __('Link Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    ">
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ active_menu('admin-home/services/category') }}"><a
                                        href="{{ route('admin.service.category') }}">{{ __('Category') }}</a>
                                </li>
                    ...
                    {{-- @if (check_page_permission_by_string('Case Study'))
                        <li class="main_dropdown @if (request()->is(['admin-home/works/*', 'admin-home/works'])) active @endif ">
                            <a href="javascript:void(0)" aria-expanded="true">
                                <i class="ti-layout"></i>
                        ...
                        @if (request()->is('admin-home/gallery-page/*')) active @endif
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ active_menu('admin-home/gallery-page/page-settings') }}">
                                    <a
                                        href="{{ route('admin.gallery.page.settings') }}">{{ __('Page Settings') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                        ...
                        @if (request()->is('admin-home/video-gallery/*')) active @endif
                            ...
                            <ul class="collapse">
                                <li class="{{ active_menu('admin-home/video-gallery') }}">
                                    <a
                                        href="{{ route('admin.video.gallery.all') }}">{{ __('Video Gallery') }}</a>
                                </li>
                        ...
                        @if (request()->is('admin-home/price-plan/*')) active @endif
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ active_menu('admin-home/price-plan/new') }}">
                                    <a
                                        href="{{ route('admin.price.plan.new') }}">{{ __('New Price Plan') }}</a>
                                </li>
                    ...
                    {{-- <li class="main_dropdown @if (request()->is(['admin-home/quote-manage/*', 'admin-home/package/*', 'admin-home/payment-logs', 'admin-home/payment-logs/report', 'admin-home/jobs', 'admin-home/jobs/*', 'admin-home/events', 'admin-home/events/*', 'admin-home/products', 'admin-home/products/*', 'admin-home/donations', 'admin-home/donations/*', 'admin-home/knowledge', 'admin-home/knowledge/*', 'admin-home/appointment/*', 'admin-home/courses/*', 'admin-home/support-tickets/*', 'admin-home/support-tickets'])) active @endif">
                                ...
                                <li class="main_dropdown @if (request()->is('admin-home/courses/*')) active @endif ">
                                    ...
                                    <ul class="collapse">
                                        <li class="{{ active_menu('admin-home/courses/all') }}">
                                            <a
                                                href="{{ route('admin.courses.all') }}">{{ __('All Courses') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/courses/new') }}">
                                            <a
                                                href="{{ route('admin.courses.new') }}">{{ __('New Course') }}</a>
                                        </li>
                            ...
                            @if (check_page_permission_by_string('Package Orders Manage'))
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li
                                            class="{{ active_menu('admin-home/package/order-manage/in-progress') }}">
                                            <a
                                                href="{{ route('admin.package.order.manage.in.progress') }}">{{ __('In Progress Order') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/package/order-manage/completed') }}">
                                            <a
                                        ...
                                        <li
                                            class="{{ active_menu('admin-home/package/order-manage/cancel-page') }}">
                                            <a
                                        ...
                                        <li class="{{ active_menu('admin-home/package/order-manage/settings') }}">
                                            <a
                            ...
                            @if (check_page_permission_by_string('Products Manage') && !empty(get_static_option('product_module_status')))
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ active_menu('admin-home/products/single-page-settings') }}">
                                            <a
                                                href="{{ route('admin.products.single.page.settings') }}">{{ __('Product Single Page Settings') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/success-page-settings') }}">
                                            <a
                                                href="{{ route('admin.products.success.page.settings') }}">{{ __('Order Success Page Settings') }}</a>
                                        </li>
                                        <li class="{{ active_menu('admin-home/products/cancel-page-settings') }}">
                                            <a
                            ...
                            @if (check_page_permission_by_string('Donations Manage') && !empty(get_static_option('donations_module_status')))
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ active_menu('admin-home/donations/single-page-settings') }}">
                                            <a
                                                href="{{ route('admin.donations.single.page.settings') }}">{{ __('Donation Single Settings') }}</a>
                                        </li>

                                        <li
                                            class="{{ active_menu('admin-home/donations/donations-payment-logs') }}">
                                            <a
                    ...
                    <li
                        class="main_dropdown
                        @if (request()->is(['admin-home/home-page-01/*', 'admin-home/home-' . $home_page_variant . '/*', 'admin-home/header', 'admin-home/keyfeatures', 'admin-home/about-page/*', 'admin-home/contact-page/*', 'admin-home/feedback-page/*', 'admin-home/404-page-manage', 'admin-home/maintains-page/settings', 'admin-home/page-builder/*'])) active @endif
                        ">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-settings"></i>
                        ...
                        <ul class="collapse ">
                            @if (check_page_permission_by_string('Home Page Manage'))
                                <li
                                    class="main_dropdown
                                @if (request()->is(['admin-home/home-' . $home_page_variant . '/*', 'admin-home/home-page-01/*', 'admin-home/header', 'admin-home/keyfeatures', 'admin-home/page-builder/home-page'])) active @endif
                                ">
                                    <a href="javascript:void(0)" aria-expanded="true">
                                        {{ __('Home Page Manage') }}
                                    </a>
                                    <ul class="collapse">
                                        ...
                                        @if (empty(get_static_option('home_page_page_builder_status')))
                                            {{-- @if (in_array($home_page_variant, ['01', '02', '03', '04']))
                                                ...
                                                <li class="{{ active_menu('admin-home/home-page-01/about-us') }}">
                                                    <a
                                                ...
                                                @endif
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-01/testimonial') }}">
                                                    <a
                                                        href="{{ route('admin.homeone.testimonial') }}">{{ __('Testimonial Area') }}</a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-01/price-plan') }}">
                                                    <a
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-page-01/latest-news') }}">
                                                    <a
                                            ...
                                            {{-- @if ($home_page_variant == '05')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-05/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '06')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-06/testimonial-area') }}">
                                            ...
                                            @if ($home_page_variant == '07')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-07/estimate-area') }}">
                                                    <a href="{{ route('admin.home07.estimate') }}">
                                                        {{ __('Comment Area') }}
                                                    </a>
                                                </li>
                                                ...
                                                <li class="{{ active_menu('admin-home/home-07/blog-area') }}">
                                                    <a href="{{ route('admin.home07.blog.area') }}">
                                                        {{ __('Blog Area') }}
                                                    </a>
                                                </li>
                                            ...
                                            {{-- @if ($home_page_variant == '08')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-08/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '09')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-09/team-member-area') }}">
                                                    <a href="{{ route('admin.home09.team.member.area') }}">
                                                        {{ __('Team Member Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-09/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '10')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-10/appointment-area') }}">
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-10/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '11')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-11/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '12')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-12/appointment-area') }}">
                                                    <a href="{{ route('admin.home12.appointment') }}">
                                                        {{ __('Appointment Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-12/case-study-area') }}">
                                                    <a href="{{ route('admin.home12.case.study') }}">
                                                        {{ __('Case Study Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-12/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '13')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-13/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '14')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-14/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '15')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-15/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '16')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-16/appointment-area') }}">
                                                    <a href="{{ route('admin.home16.appointment') }}">
                                                        {{ __('Appointment Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-16/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '17')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-17/featured-courses') }}">
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-17/all-courses-area') }}">
                                                    <a href="{{ route('admin.home17.all.courses.area') }}">
                                                        {{ __('All Courses Area') }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="{{ active_menu('admin-home/home-17/testimonial-area') }}">
                                            ...
                                            {{-- @if ($home_page_variant == '18')
                                                ...
                                                <li
                                                    class="{{ active_menu('admin-home/home-18/testimonial-area') }}">
                                            ...
                                            <li
                                                class="{{ active_menu('admin-home/home-page-01/section-manage') }}">
                                                <a
                                ...
                                <li class="main_dropdown @if (request()->is('admin-home/about-page/*') || request()->is('admin-home/page-builder/about-page')) active @endif ">
                                    ...
                                    <ul class="collapse">
                                        @if (empty(get_static_option('about_page_page_builder_status')))
                                            ...
                                            <li class="{{ active_menu('admin-home/about-page/global-network') }}">
                                                <a
                                ...
                                <li class="main_dropdown @if (request()->is(['admin-home/contact-page/*', 'admin-home/page-builder/contact-page'])) active @endif">
                                    ...
                                    <ul class="collapse">
                                        @if (empty(get_static_option('contact_page_page_builder_status')))
                                            ...
                                            <li
                                                class="{{ active_menu('admin-home/contact-page/section-manage') }}">
                                                <a
                    ...
                    <li class="main_dropdown @if (request()->is(['admin-home/form-builder/*', 'admin-home/email-template/*', 'admin-home/popup-builder/*', 'admin-home/widgets/*', 'admin-home/widgets', 'admin-home/menu-edit/*', 'admin-home/media-upload/page', 'admin-home/menu', 'admin-home/appearance-setting/*'])) active @endif">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-settings"></i>
                            ...
                            @if (check_page_permission_by_string('Form Builder'))
                                <li class="main_dropdown @if (request()->is('admin-home/form-builder/*')) active @endif">
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ active_menu('admin-home/form-builder/case-study-query') }}">
                                            <a
                                        ...
                                        <li class="{{ active_menu('admin-home/form-builder/event-attendance') }}">
                                            <a
                                                href="{{ route('admin.form.builder.event.attendance.form') }}">{{ __('Event Attendance Form') }}</a>
                                        </li>
                                        <li
                                            class="{{ active_menu('admin-home/form-builder/appoinment-booking') }}">
                                            <a
